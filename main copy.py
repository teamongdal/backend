...
async def search_product(
    ...
    try:
        ...
        if video_id == "video_0001":
            dami = [(0.00, 7.07), (8.20, 12.05), (14.15, 16.19), (19.15, 22.05), (25.14, 26.17), (29.21, 31.27), (34.25, 36.15)]
            nj = [(16.19, 19.14), (22.06, 23.23), (33.11, 34.25), (39.28, 41.17)]
            if timestamp_float > dami[i][0] and timestamp_float < dami[i][1]:
                image_file_path = "static/local_data/highlight_image/highlight_0001_0001.png"
            elif timestamp_float > nj[i][0] and timestamp_float < nj[i][0]:
            ...
            if timestamp_float > choi[i][0] and timestamp_float < choi[i][1]:
                image_file_path = "static/local_data/highlight_image/highlight_0002_0001.png"
            elif timestamp_float > guy[i][0] and timestamp_float < guy[i][1]:
